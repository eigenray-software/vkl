...
struct VklDeviceFunctions {
	...
	void GetImageMemoryRequirements2KHR(const  VkImageMemoryRequirementsInfo2 * pInfo, VkMemoryRequirements2 * pMemoryRequirements) {
		assert(pfn_vkGetImageMemoryRequirements2KHR && "vkGetImageMemoryRequirements2KHR is not loaded");
		pfn_vkGetImageMemoryRequirements2KHR(this->handle, pInfo, pMemoryRequirements);
	}
	...
	void GetBufferMemoryRequirements2KHR(const  VkBufferMemoryRequirementsInfo2 * pInfo, VkMemoryRequirements2 * pMemoryRequirements) {
		assert(pfn_vkGetBufferMemoryRequirements2KHR && "vkGetBufferMemoryRequirements2KHR is not loaded");
		pfn_vkGetBufferMemoryRequirements2KHR(this->handle, pInfo, pMemoryRequirements);
	}
	...
	void GetImageSparseMemoryRequirements2KHR(const  VkImageSparseMemoryRequirementsInfo2 * pInfo, uint32_t * pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2 * pSparseMemoryRequirements) {
		assert(pfn_vkGetImageSparseMemoryRequirements2KHR && "vkGetImageSparseMemoryRequirements2KHR is not loaded");
		pfn_vkGetImageSparseMemoryRequirements2KHR(this->handle, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	}
	...
	VkResult CreateRenderPass2KHR(const  VkRenderPassCreateInfo2 * pCreateInfo, const  VkAllocationCallbacks * pAllocator, VkRenderPass * pRenderPass) {
		assert(pfn_vkCreateRenderPass2KHR && "vkCreateRenderPass2KHR is not loaded");
		return pfn_vkCreateRenderPass2KHR(this->handle, pCreateInfo, pAllocator, pRenderPass);
	}
	...
	void GetDescriptorSetLayoutSupportKHR(const  VkDescriptorSetLayoutCreateInfo * pCreateInfo, VkDescriptorSetLayoutSupport * pSupport) {
		assert(pfn_vkGetDescriptorSetLayoutSupportKHR && "vkGetDescriptorSetLayoutSupportKHR is not loaded");
		pfn_vkGetDescriptorSetLayoutSupportKHR(this->handle, pCreateInfo, pSupport);
	}
	...
	VkResult GetRayTracingShaderGroupHandlesNV(VkPipeline pipeline, uint32_t firstGroup, uint32_t groupCount, size_t dataSize, void * pData) {
		assert(pfn_vkGetRayTracingShaderGroupHandlesNV && "vkGetRayTracingShaderGroupHandlesNV is not loaded");
		return pfn_vkGetRayTracingShaderGroupHandlesNV(this->handle, pipeline, firstGroup, groupCount, dataSize, pData);
	}
...
#endif
#ifdef VK_EXT_private_data
	VkResult CreatePrivateDataSlotEXT(const  VkPrivateDataSlotCreateInfo * pCreateInfo, const  VkAllocationCallbacks * pAllocator, VkPrivateDataSlot * pPrivateDataSlot) {
		assert(pfn_vkCreatePrivateDataSlotEXT && "vkCreatePrivateDataSlotEXT is not loaded");
		return pfn_vkCreatePrivateDataSlotEXT(this->handle, pCreateInfo, pAllocator, pPrivateDataSlot);
	}

	void DestroyPrivateDataSlotEXT(VkPrivateDataSlot privateDataSlot, const  VkAllocationCallbacks * pAllocator) {
		assert(pfn_vkDestroyPrivateDataSlotEXT && "vkDestroyPrivateDataSlotEXT is not loaded");
		pfn_vkDestroyPrivateDataSlotEXT(this->handle, privateDataSlot, pAllocator);
	}

	VkResult SetPrivateDataEXT(VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t data) {
		assert(pfn_vkSetPrivateDataEXT && "vkSetPrivateDataEXT is not loaded");
		return pfn_vkSetPrivateDataEXT(this->handle, objectType, objectHandle, privateDataSlot, data);
	}

	void GetPrivateDataEXT(VkObjectType objectType, uint64_t objectHandle, VkPrivateDataSlot privateDataSlot, uint64_t * pData) {
		assert(pfn_vkGetPrivateDataEXT && "vkGetPrivateDataEXT is not loaded");
		pfn_vkGetPrivateDataEXT(this->handle, objectType, objectHandle, privateDataSlot, pData);
	}
	...
	VkResult CreateDescriptorUpdateTemplateKHR(const  VkDescriptorUpdateTemplateCreateInfo * pCreateInfo, const  VkAllocationCallbacks * pAllocator, VkDescriptorUpdateTemplate * pDescriptorUpdateTemplate) {
		assert(pfn_vkCreateDescriptorUpdateTemplateKHR && "vkCreateDescriptorUpdateTemplateKHR is not loaded");
		return pfn_vkCreateDescriptorUpdateTemplateKHR(this->handle, pCreateInfo, pAllocator, pDescriptorUpdateTemplate);
	}
	...
	void DestroyDescriptorUpdateTemplateKHR(VkDescriptorUpdateTemplate descriptorUpdateTemplate, const  VkAllocationCallbacks * pAllocator) {
		assert(pfn_vkDestroyDescriptorUpdateTemplateKHR && "vkDestroyDescriptorUpdateTemplateKHR is not loaded");
		pfn_vkDestroyDescriptorUpdateTemplateKHR(this->handle, descriptorUpdateTemplate, pAllocator);
	}
	...
	void UpdateDescriptorSetWithTemplateKHR(VkDescriptorSet descriptorSet, VkDescriptorUpdateTemplate descriptorUpdateTemplate, const  void * pData) {
		assert(pfn_vkUpdateDescriptorSetWithTemplateKHR && "vkUpdateDescriptorSetWithTemplateKHR is not loaded");
		pfn_vkUpdateDescriptorSetWithTemplateKHR(this->handle, descriptorSet, descriptorUpdateTemplate, pData);
	}
	...
	VkResult BindBufferMemory2KHR(uint32_t bindInfoCount, const  VkBindBufferMemoryInfo * pBindInfos) {
		assert(pfn_vkBindBufferMemory2KHR && "vkBindBufferMemory2KHR is not loaded");
		return pfn_vkBindBufferMemory2KHR(this->handle, bindInfoCount, pBindInfos);
	}

	VkResult BindImageMemory2KHR(uint32_t bindInfoCount, const  VkBindImageMemoryInfo * pBindInfos) {
		assert(pfn_vkBindImageMemory2KHR && "vkBindImageMemory2KHR is not loaded");
		return pfn_vkBindImageMemory2KHR(this->handle, bindInfoCount, pBindInfos);
	}
	...
	VkDeviceAddress GetBufferDeviceAddressKHR(const  VkBufferDeviceAddressInfo * pInfo) {
		assert(pfn_vkGetBufferDeviceAddressKHR && "vkGetBufferDeviceAddressKHR is not loaded");
		return pfn_vkGetBufferDeviceAddressKHR(this->handle, pInfo);
	}

	uint64_t GetBufferOpaqueCaptureAddressKHR(const  VkBufferDeviceAddressInfo * pInfo) {
		assert(pfn_vkGetBufferOpaqueCaptureAddressKHR && "vkGetBufferOpaqueCaptureAddressKHR is not loaded");
		return pfn_vkGetBufferOpaqueCaptureAddressKHR(this->handle, pInfo);
	}

	uint64_t GetDeviceMemoryOpaqueCaptureAddressKHR(const  VkDeviceMemoryOpaqueCaptureAddressInfo * pInfo) {
		assert(pfn_vkGetDeviceMemoryOpaqueCaptureAddressKHR && "vkGetDeviceMemoryOpaqueCaptureAddressKHR is not loaded");
		return pfn_vkGetDeviceMemoryOpaqueCaptureAddressKHR(this->handle, pInfo);
	}
	...
	VkResult CreateSamplerYcbcrConversionKHR(const  VkSamplerYcbcrConversionCreateInfo * pCreateInfo, const  VkAllocationCallbacks * pAllocator, VkSamplerYcbcrConversion * pYcbcrConversion) {
		assert(pfn_vkCreateSamplerYcbcrConversionKHR && "vkCreateSamplerYcbcrConversionKHR is not loaded");
		return pfn_vkCreateSamplerYcbcrConversionKHR(this->handle, pCreateInfo, pAllocator, pYcbcrConversion);
	}

	void DestroySamplerYcbcrConversionKHR(VkSamplerYcbcrConversion ycbcrConversion, const  VkAllocationCallbacks * pAllocator) {
		assert(pfn_vkDestroySamplerYcbcrConversionKHR && "vkDestroySamplerYcbcrConversionKHR is not loaded");
		pfn_vkDestroySamplerYcbcrConversionKHR(this->handle, ycbcrConversion, pAllocator);
	}
	...
	void TrimCommandPoolKHR(VkCommandPool commandPool, VkCommandPoolTrimFlags flags) {
		assert(pfn_vkTrimCommandPoolKHR && "vkTrimCommandPoolKHR is not loaded");
		pfn_vkTrimCommandPoolKHR(this->handle, commandPool, flags);
	}

#endif
#ifdef VK_EXT_host_query_reset
	void ResetQueryPoolEXT(VkQueryPool queryPool, uint32_t firstQuery, uint32_t queryCount) {
		assert(pfn_vkResetQueryPoolEXT && "vkResetQueryPoolEXT is not loaded");
		pfn_vkResetQueryPoolEXT(this->handle, queryPool, firstQuery, queryCount);
	}

#endif
#ifdef VK_KHR_timeline_semaphore
	VkResult GetSemaphoreCounterValueKHR(VkSemaphore semaphore, uint64_t * pValue) {
		assert(pfn_vkGetSemaphoreCounterValueKHR && "vkGetSemaphoreCounterValueKHR is not loaded");
		return pfn_vkGetSemaphoreCounterValueKHR(this->handle, semaphore, pValue);
	}

	VkResult WaitSemaphoresKHR(const  VkSemaphoreWaitInfo * pWaitInfo, uint64_t timeout) {
		assert(pfn_vkWaitSemaphoresKHR && "vkWaitSemaphoresKHR is not loaded");
		return pfn_vkWaitSemaphoresKHR(this->handle, pWaitInfo, timeout);
	}

	VkResult SignalSemaphoreKHR(const  VkSemaphoreSignalInfo * pSignalInfo) {
		assert(pfn_vkSignalSemaphoreKHR && "vkSignalSemaphoreKHR is not loaded");
		return pfn_vkSignalSemaphoreKHR(this->handle, pSignalInfo);
	}
	...
	void GetDeviceGroupPeerMemoryFeaturesKHR(uint32_t heapIndex, uint32_t localDeviceIndex, uint32_t remoteDeviceIndex, VkPeerMemoryFeatureFlags * pPeerMemoryFeatures) {
		assert(pfn_vkGetDeviceGroupPeerMemoryFeaturesKHR && "vkGetDeviceGroupPeerMemoryFeaturesKHR is not loaded");
		pfn_vkGetDeviceGroupPeerMemoryFeaturesKHR(this->handle, heapIndex, localDeviceIndex, remoteDeviceIndex, pPeerMemoryFeatures);
	}
...
#endif
#ifdef VK_KHR_maintenance4
	void GetDeviceBufferMemoryRequirementsKHR(const  VkDeviceBufferMemoryRequirements * pInfo, VkMemoryRequirements2 * pMemoryRequirements) {
		assert(pfn_vkGetDeviceBufferMemoryRequirementsKHR && "vkGetDeviceBufferMemoryRequirementsKHR is not loaded");
		pfn_vkGetDeviceBufferMemoryRequirementsKHR(this->handle, pInfo, pMemoryRequirements);
	}

	void GetDeviceImageMemoryRequirementsKHR(const  VkDeviceImageMemoryRequirements * pInfo, VkMemoryRequirements2 * pMemoryRequirements) {
		assert(pfn_vkGetDeviceImageMemoryRequirementsKHR && "vkGetDeviceImageMemoryRequirementsKHR is not loaded");
		pfn_vkGetDeviceImageMemoryRequirementsKHR(this->handle, pInfo, pMemoryRequirements);
	}

	void GetDeviceImageSparseMemoryRequirementsKHR(const  VkDeviceImageMemoryRequirements * pInfo, uint32_t * pSparseMemoryRequirementCount, VkSparseImageMemoryRequirements2 * pSparseMemoryRequirements) {
		assert(pfn_vkGetDeviceImageSparseMemoryRequirementsKHR && "vkGetDeviceImageSparseMemoryRequirementsKHR is not loaded");
		pfn_vkGetDeviceImageSparseMemoryRequirementsKHR(this->handle, pInfo, pSparseMemoryRequirementCount, pSparseMemoryRequirements);
	}

#endif
#ifdef VK_EXT_buffer_device_address
	VkDeviceAddress GetBufferDeviceAddressEXT(const  VkBufferDeviceAddressInfo * pInfo) {
		assert(pfn_vkGetBufferDeviceAddressEXT && "vkGetBufferDeviceAddressEXT is not loaded");
		return pfn_vkGetBufferDeviceAddressEXT(this->handle, pInfo);
	}
...
struct VklCommandFunctions {
...
#ifdef VK_KHR_create_renderpass2
	void BeginRenderPass2KHR(const  VkRenderPassBeginInfo * pRenderPassBegin, const  VkSubpassBeginInfo * pSubpassBeginInfo) {
		assert(fnptrs->pfn_vkCmdBeginRenderPass2KHR && "vkCmdBeginRenderPass2KHR is not loaded");
		fnptrs->pfn_vkCmdBeginRenderPass2KHR(this->handle, pRenderPassBegin, pSubpassBeginInfo);
	}

	void NextSubpass2KHR(const  VkSubpassBeginInfo * pSubpassBeginInfo, const  VkSubpassEndInfo * pSubpassEndInfo) {
		assert(fnptrs->pfn_vkCmdNextSubpass2KHR && "vkCmdNextSubpass2KHR is not loaded");
		fnptrs->pfn_vkCmdNextSubpass2KHR(this->handle, pSubpassBeginInfo, pSubpassEndInfo);
	}

	void EndRenderPass2KHR(const  VkSubpassEndInfo * pSubpassEndInfo) {
		assert(fnptrs->pfn_vkCmdEndRenderPass2KHR && "vkCmdEndRenderPass2KHR is not loaded");
		fnptrs->pfn_vkCmdEndRenderPass2KHR(this->handle, pSubpassEndInfo);
	}
...
#ifdef VK_KHR_synchronization2
	void SetEvent2KHR(VkEvent event, const  VkDependencyInfo * pDependencyInfo) {
		assert(fnptrs->pfn_vkCmdSetEvent2KHR && "vkCmdSetEvent2KHR is not loaded");
		fnptrs->pfn_vkCmdSetEvent2KHR(this->handle, event, pDependencyInfo);
	}

	void ResetEvent2KHR(VkEvent event, VkPipelineStageFlags2 stageMask) {
		assert(fnptrs->pfn_vkCmdResetEvent2KHR && "vkCmdResetEvent2KHR is not loaded");
		fnptrs->pfn_vkCmdResetEvent2KHR(this->handle, event, stageMask);
	}

	void WaitEvents2KHR(uint32_t eventCount, const  VkEvent * pEvents, const  VkDependencyInfo * pDependencyInfos) {
		assert(fnptrs->pfn_vkCmdWaitEvents2KHR && "vkCmdWaitEvents2KHR is not loaded");
		fnptrs->pfn_vkCmdWaitEvents2KHR(this->handle, eventCount, pEvents, pDependencyInfos);
	}

	void PipelineBarrier2KHR(const  VkDependencyInfo * pDependencyInfo) {
		assert(fnptrs->pfn_vkCmdPipelineBarrier2KHR && "vkCmdPipelineBarrier2KHR is not loaded");
		fnptrs->pfn_vkCmdPipelineBarrier2KHR(this->handle, pDependencyInfo);
	}

	void WriteTimestamp2KHR(VkPipelineStageFlags2 stage, VkQueryPool queryPool, uint32_t query) {
		assert(fnptrs->pfn_vkCmdWriteTimestamp2KHR && "vkCmdWriteTimestamp2KHR is not loaded");
		fnptrs->pfn_vkCmdWriteTimestamp2KHR(this->handle, stage, queryPool, query);
	}
...
#ifdef VK_KHR_draw_indirect_count
	void DrawIndirectCountKHR(VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) {
		assert(fnptrs->pfn_vkCmdDrawIndirectCountKHR && "vkCmdDrawIndirectCountKHR is not loaded");
		fnptrs->pfn_vkCmdDrawIndirectCountKHR(this->handle, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	}

	void DrawIndexedIndirectCountKHR(VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) {
		assert(fnptrs->pfn_vkCmdDrawIndexedIndirectCountKHR && "vkCmdDrawIndexedIndirectCountKHR is not loaded");
		fnptrs->pfn_vkCmdDrawIndexedIndirectCountKHR(this->handle, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	}
...
#ifdef VK_AMD_draw_indirect_count
	void DrawIndirectCountAMD(VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) {
		assert(fnptrs->pfn_vkCmdDrawIndirectCountAMD && "vkCmdDrawIndirectCountAMD is not loaded");
		fnptrs->pfn_vkCmdDrawIndirectCountAMD(this->handle, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	}

	void DrawIndexedIndirectCountAMD(VkBuffer buffer, VkDeviceSize offset, VkBuffer countBuffer, VkDeviceSize countBufferOffset, uint32_t maxDrawCount, uint32_t stride) {
		assert(fnptrs->pfn_vkCmdDrawIndexedIndirectCountAMD && "vkCmdDrawIndexedIndirectCountAMD is not loaded");
		fnptrs->pfn_vkCmdDrawIndexedIndirectCountAMD(this->handle, buffer, offset, countBuffer, countBufferOffset, maxDrawCount, stride);
	}
...
#ifdef VK_KHR_dynamic_rendering
	void BeginRenderingKHR(const  VkRenderingInfo * pRenderingInfo) {
		assert(fnptrs->pfn_vkCmdBeginRenderingKHR && "vkCmdBeginRenderingKHR is not loaded");
		fnptrs->pfn_vkCmdBeginRenderingKHR(this->handle, pRenderingInfo);
	}

	void EndRenderingKHR() {
		assert(fnptrs->pfn_vkCmdEndRenderingKHR && "vkCmdEndRenderingKHR is not loaded");
		fnptrs->pfn_vkCmdEndRenderingKHR(this->handle);
	}
	...
	void SetCullModeEXT(VkCullModeFlags cullMode) {
		assert(fnptrs->pfn_vkCmdSetCullModeEXT && "vkCmdSetCullModeEXT is not loaded");
		fnptrs->pfn_vkCmdSetCullModeEXT(this->handle, cullMode);
	}

	void SetFrontFaceEXT(VkFrontFace frontFace) {
		assert(fnptrs->pfn_vkCmdSetFrontFaceEXT && "vkCmdSetFrontFaceEXT is not loaded");
		fnptrs->pfn_vkCmdSetFrontFaceEXT(this->handle, frontFace);
	}

	void SetPrimitiveTopologyEXT(VkPrimitiveTopology primitiveTopology) {
		assert(fnptrs->pfn_vkCmdSetPrimitiveTopologyEXT && "vkCmdSetPrimitiveTopologyEXT is not loaded");
		fnptrs->pfn_vkCmdSetPrimitiveTopologyEXT(this->handle, primitiveTopology);
	}

	void SetViewportWithCountEXT(uint32_t viewportCount, const  VkViewport * pViewports) {
		assert(fnptrs->pfn_vkCmdSetViewportWithCountEXT && "vkCmdSetViewportWithCountEXT is not loaded");
		fnptrs->pfn_vkCmdSetViewportWithCountEXT(this->handle, viewportCount, pViewports);
	}

	void SetScissorWithCountEXT(uint32_t scissorCount, const  VkRect2D * pScissors) {
		assert(fnptrs->pfn_vkCmdSetScissorWithCountEXT && "vkCmdSetScissorWithCountEXT is not loaded");
		fnptrs->pfn_vkCmdSetScissorWithCountEXT(this->handle, scissorCount, pScissors);
	}

	void BindVertexBuffers2EXT(uint32_t firstBinding, uint32_t bindingCount, const  VkBuffer * pBuffers, const  VkDeviceSize * pOffsets, const  VkDeviceSize * pSizes, const  VkDeviceSize * pStrides) {
		assert(fnptrs->pfn_vkCmdBindVertexBuffers2EXT && "vkCmdBindVertexBuffers2EXT is not loaded");
		fnptrs->pfn_vkCmdBindVertexBuffers2EXT(this->handle, firstBinding, bindingCount, pBuffers, pOffsets, pSizes, pStrides);
	}

	void SetDepthTestEnableEXT(VkBool32 depthTestEnable) {
		assert(fnptrs->pfn_vkCmdSetDepthTestEnableEXT && "vkCmdSetDepthTestEnableEXT is not loaded");
		fnptrs->pfn_vkCmdSetDepthTestEnableEXT(this->handle, depthTestEnable);
	}

	void SetDepthWriteEnableEXT(VkBool32 depthWriteEnable) {
		assert(fnptrs->pfn_vkCmdSetDepthWriteEnableEXT && "vkCmdSetDepthWriteEnableEXT is not loaded");
		fnptrs->pfn_vkCmdSetDepthWriteEnableEXT(this->handle, depthWriteEnable);
	}

	void SetDepthCompareOpEXT(VkCompareOp depthCompareOp) {
		assert(fnptrs->pfn_vkCmdSetDepthCompareOpEXT && "vkCmdSetDepthCompareOpEXT is not loaded");
		fnptrs->pfn_vkCmdSetDepthCompareOpEXT(this->handle, depthCompareOp);
	}

	void SetDepthBoundsTestEnableEXT(VkBool32 depthBoundsTestEnable) {
		assert(fnptrs->pfn_vkCmdSetDepthBoundsTestEnableEXT && "vkCmdSetDepthBoundsTestEnableEXT is not loaded");
		fnptrs->pfn_vkCmdSetDepthBoundsTestEnableEXT(this->handle, depthBoundsTestEnable);
	}

	void SetStencilTestEnableEXT(VkBool32 stencilTestEnable) {
		assert(fnptrs->pfn_vkCmdSetStencilTestEnableEXT && "vkCmdSetStencilTestEnableEXT is not loaded");
		fnptrs->pfn_vkCmdSetStencilTestEnableEXT(this->handle, stencilTestEnable);
	}

	void SetStencilOpEXT(VkStencilFaceFlags faceMask, VkStencilOp failOp, VkStencilOp passOp, VkStencilOp depthFailOp, VkCompareOp compareOp) {
		assert(fnptrs->pfn_vkCmdSetStencilOpEXT && "vkCmdSetStencilOpEXT is not loaded");
		fnptrs->pfn_vkCmdSetStencilOpEXT(this->handle, faceMask, failOp, passOp, depthFailOp, compareOp);
	}
	...
	void SetRasterizerDiscardEnableEXT(VkBool32 rasterizerDiscardEnable) {
		assert(fnptrs->pfn_vkCmdSetRasterizerDiscardEnableEXT && "vkCmdSetRasterizerDiscardEnableEXT is not loaded");
		fnptrs->pfn_vkCmdSetRasterizerDiscardEnableEXT(this->handle, rasterizerDiscardEnable);
	}

	void SetDepthBiasEnableEXT(VkBool32 depthBiasEnable) {
		assert(fnptrs->pfn_vkCmdSetDepthBiasEnableEXT && "vkCmdSetDepthBiasEnableEXT is not loaded");
		fnptrs->pfn_vkCmdSetDepthBiasEnableEXT(this->handle, depthBiasEnable);
	}
	...
	void SetPrimitiveRestartEnableEXT(VkBool32 primitiveRestartEnable) {
		assert(fnptrs->pfn_vkCmdSetPrimitiveRestartEnableEXT && "vkCmdSetPrimitiveRestartEnableEXT is not loaded");
		fnptrs->pfn_vkCmdSetPrimitiveRestartEnableEXT(this->handle, primitiveRestartEnable);
	}
	...
	void SetDeviceMaskKHR(uint32_t deviceMask) {
		assert(fnptrs->pfn_vkCmdSetDeviceMaskKHR && "vkCmdSetDeviceMaskKHR is not loaded");
		fnptrs->pfn_vkCmdSetDeviceMaskKHR(this->handle, deviceMask);
	}
	...
	void DispatchBaseKHR(uint32_t baseGroupX, uint32_t baseGroupY, uint32_t baseGroupZ, uint32_t groupCountX, uint32_t groupCountY, uint32_t groupCountZ) {
		assert(fnptrs->pfn_vkCmdDispatchBaseKHR && "vkCmdDispatchBaseKHR is not loaded");
		fnptrs->pfn_vkCmdDispatchBaseKHR(this->handle, baseGroupX, baseGroupY, baseGroupZ, groupCountX, groupCountY, groupCountZ);
	}
...
#ifdef VK_KHR_copy_commands2
	void CopyBuffer2KHR(const  VkCopyBufferInfo2 * pCopyBufferInfo) {
		assert(fnptrs->pfn_vkCmdCopyBuffer2KHR && "vkCmdCopyBuffer2KHR is not loaded");
		fnptrs->pfn_vkCmdCopyBuffer2KHR(this->handle, pCopyBufferInfo);
	}

	void CopyImage2KHR(const  VkCopyImageInfo2 * pCopyImageInfo) {
		assert(fnptrs->pfn_vkCmdCopyImage2KHR && "vkCmdCopyImage2KHR is not loaded");
		fnptrs->pfn_vkCmdCopyImage2KHR(this->handle, pCopyImageInfo);
	}

	void CopyBufferToImage2KHR(const  VkCopyBufferToImageInfo2 * pCopyBufferToImageInfo) {
		assert(fnptrs->pfn_vkCmdCopyBufferToImage2KHR && "vkCmdCopyBufferToImage2KHR is not loaded");
		fnptrs->pfn_vkCmdCopyBufferToImage2KHR(this->handle, pCopyBufferToImageInfo);
	}

	void CopyImageToBuffer2KHR(const  VkCopyImageToBufferInfo2 * pCopyImageToBufferInfo) {
		assert(fnptrs->pfn_vkCmdCopyImageToBuffer2KHR && "vkCmdCopyImageToBuffer2KHR is not loaded");
		fnptrs->pfn_vkCmdCopyImageToBuffer2KHR(this->handle, pCopyImageToBufferInfo);
	}

	void BlitImage2KHR(const  VkBlitImageInfo2 * pBlitImageInfo) {
		assert(fnptrs->pfn_vkCmdBlitImage2KHR && "vkCmdBlitImage2KHR is not loaded");
		fnptrs->pfn_vkCmdBlitImage2KHR(this->handle, pBlitImageInfo);
	}

	void ResolveImage2KHR(const  VkResolveImageInfo2 * pResolveImageInfo) {
		assert(fnptrs->pfn_vkCmdResolveImage2KHR && "vkCmdResolveImage2KHR is not loaded");
		fnptrs->pfn_vkCmdResolveImage2KHR(this->handle, pResolveImageInfo);
	}
...
#ifdef VK_KHR_synchronization2
	VkResult Submit2KHR(uint32_t submitCount, const  VkSubmitInfo2 * pSubmits, VkFence fence) {
		assert(fnptrs->pfn_vkQueueSubmit2KHR && "vkQueueSubmit2KHR is not loaded");
		return fnptrs->pfn_vkQueueSubmit2KHR(this->handle, submitCount, pSubmits, fence);
	}
